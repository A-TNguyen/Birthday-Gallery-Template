...
function createPointerData(
  ...
  if (!pointerMap.has(options.domElement)) {
    ...
    pointerMap.set(elem, defaultData);
    if (!globalPointerActive) {
      ...
      elem.addEventListener("touchstart", onTouchStart as EventListener, {
        passive: false,
      });
      elem.addEventListener("touchmove", onTouchMove as EventListener, {
        passive: false,
      });
      elem.addEventListener("touchend", onTouchEnd as EventListener, {
        passive: false,
      });
      elem.addEventListener("touchcancel", onTouchEnd as EventListener, {
        passive: false,
      });
